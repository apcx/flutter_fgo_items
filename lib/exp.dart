        ...
        body: Obx(() {
          ...
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              IconButton(icon: Icon(Icons.arrow_back), onPressed: () => _level.value = max(1, _level.value - 1)),
              IconButton(
                  icon: Icon(Icons.arrow_forward),
                  onPressed: () => _level.value = min(_level.value + 1, _maxLevel.value - 1))
            ]),
            ...
            Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    SizedBox(width: 140, child: Text('到 $_maxLevel 级所需经验：')),
                    Container(
                        width: 100,
